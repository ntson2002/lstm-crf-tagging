...
optparser.add_option(
    "-d", "--dev", default="new_dev1.txt",
    help="Dev set location"
)
optparser.add_option(
    "-t", "--test", default="new_test1.txt",
...
for epoch in xrange(n_epochs):
    ...
    for i, index in enumerate(np.random.permutation(len(train_data))):
        ...
        if count % freq_eval == 0:
            ...
            dev_score, iob_dev_score, s_result_dev = evaluate(parameters, f_eval, dev_sentences,
                                 dev_data, id_to_tag, dico_tags)
            print s_result_dev
            print "##### EVALUATE on TEST"
            test_score, iob_test_score, s_result_test = evaluate(parameters, f_eval, test_sentences,
