...
default_out_file = "/home/s1520203/Bitbucket/lstm-crf-tagging/experiments/jp-rre/jpc-new-scripts/test-results/fold.0.test.conll.txt"
default_prefix = ""
...
predict(parameters, f_eval, test_sentences, test_data, model.id_to_tag, out_file, add_O_tags=True)
