...
def evaluate_multilayer(parameters, f_eval, raw_sentences, parsed_sentences, tag_maps,
    ...
    for tm in tag_maps:
        ...
        # print "EVALUATION OF LAYER " + str(tm['layer'])
...
# def evaluate2(parameters, f_eval, raw_sentences, parsed_sentences,
#              id_to_tag, dictionary_tags, output):
#     """
#     Evaluate current model using CoNLL script.
#     """
#     n_tags = len(id_to_tag)
